class FoodItemController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @food_item.update(food_item_params)
        format.html { redirect_to @food_item, notice: 'Serving was successfully updated.' }
  ...
  def destroy
    @food_item.destroy
    respond_to do |format|
      format.html { redirect_to food_items_url, notice: 'Serving was successfully destroyed.' }
  ...
  private
    ...
    def food_item_params
      params.require(:food_item).permit(:name, :category_id, :notes)
    end
end
