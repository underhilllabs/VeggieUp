...
class ServingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create serving" do
    assert_difference('Serving.count') do
      post servings_url, params: { serving: { category: @serving.category, day: @serving.day, food_item: @serving.food_item, notes: @serving.notes } }
    end
  ...
  test "should update serving" do
    patch serving_url(@serving), params: { serving: { category: @serving.category, day: @serving.day, food_item: @serving.food_item, notes: @serving.notes } }
